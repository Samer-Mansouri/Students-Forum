...
export default function Navbar() {
  ...
  return (
    <>
    <Popover className="relative bg-white z-100">
        ...
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <Popover.Group as="nav" className="hidden md:flex space-x-10">
            ...
            
            {
              ...
              <>
               <NavLink to="/forum" className="text-base font-medium text-gray-500 hover:text-gray-900">
              Forum
            </NavLink>
              <NavLink to="/voice" className="text-base font-medium text-gray-500 hover:text-gray-900">
              Voice notes
            </NavLink>
            <NavLink to="/libary" className="text-base font-medium text-gray-500 hover:text-gray-900">
              Libary
            </NavLink>
